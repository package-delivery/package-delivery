...
public class ConvexHullTest {
    ...
    class checkNearestInsertion {
        ...
        void checkConvexHullTest() {
            ...
            assertEquals(12.92947302460169, result.getDistance());
            String expected = ch.getResult().getSortedCities().toString();
            assertEquals(expected, "[City{cityName='[2.0,2.0]', id=0}, City{cityName='[1.548,2.961]', id=0}, City{cityName='[1.559,3.995]', id=0}, City{cityName='[2.56,3.95]', id=0}, City{cityName='[4.0,4.0]', id=0}, City{cityName='[3.0,5.0]', id=0}, City{cityName='[2.088,5.209]', id=0}, City{cityName='[0.683,5.12]', id=0}, City{cityName='[0.885,4.467]', id=0}, City{cityName='[0.0,3.0]', id=0}, City{cityName='[2.0,2.0]', id=0}]");
        }
    }
}
